...
image::persistenceconfig.png[주석추가]
...
[IMPORTANT]
====
클래스에서 아래의 패키지 이름을 제거하지 않도록 주의하세요.
====
...
이제 변환 대상에 대한 옵션이 표시됩니다. 이전과 마찬가지로 애플리케이션 분석에 대한 매개변수로 `Containerization`, `Linux`, `OpenJDK` 를 클릭합니다.
